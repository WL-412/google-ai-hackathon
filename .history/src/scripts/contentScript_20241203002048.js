...
function updateCursorStyle() {
  if (highlightModeActive) {
    document.body.style.cursor = chrome.runtime.getURL('./public/highlight-pen.png'); // Highlight mode cursor
  } else if (isAnswerMode) {
    document.body.style.cursor = chrome.runtime.getURL('./public/highlight-pen.png'); // Answer mode cursor
  } else {
