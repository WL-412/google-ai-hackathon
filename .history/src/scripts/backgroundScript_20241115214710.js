...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.action === 'summarize_page') {
    ...
    runPrompt(`Generate 5 questions and answers(answers are the original sentences from the article) based on the key points of the article. Give me questions and answers only, no other text.`, params, content)
      .then(summary => {
