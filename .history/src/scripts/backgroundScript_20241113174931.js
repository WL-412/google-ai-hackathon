...
async function validateAnswer(question, userAnswer) {
  const prompt = `Under the context of the article, evaluate the answer to this question: "${question}" with the user answer: "${userAnswer}". Respond with 'Correct' if the answer is correct, otherwise provide a hint.`;
