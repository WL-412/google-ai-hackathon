...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.action === 'summarize_page') {
    ...
    runPrompt(`Generate 5 questions and answers based on the key points of the article. Give me questions and answers only, no other text. Form the answer to be a word from the article.`, params, content)
      .then(summary => {
