...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.action === 'summarize_page') {
    ...
    runPrompt(`Generate 5 questions based on the key points of the article. And generate three choices to be a multiple choice question Give me questions and choices only, no other text.`, params, content)
      .then(summary => {
