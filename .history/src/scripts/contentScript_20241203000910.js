...
// Define the cursor style (e.g., a custom cursor or predefined styles like 'pointer', 'crosshair', etc.)
const customCursorStyle = 'crosshair'; // Change this to your desired style or URL for a custom cursor

// Apply the cursor style to the entire page
document.body.style.cursor = customCursorStyle;
