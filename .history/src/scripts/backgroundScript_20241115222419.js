...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.action === 'summarize_page') {
    ...
    runPrompt(`Generate 5 questions and keywords(three keywords to answer each quesiton) based on the key points of the article. Give me questions and keywords only, no other text.`, params, content)
      .then(summary => {
